...
export default class SteamFileUploads extends Snowboard.Singleton {
    construct() {
        this.Vapor = require('laravel-vapor');
    }
    ...
    mediaManager(mediaManager) {
        const _this = this;
        mediaManager.dropzone._uploadData = function _uploadData(files, dataBlocks) {
    ...
    fileUpload(fileUpload) {
        const _this = this;
        fileUpload.dropzone._uploadData = function _uploadData(files, dataBlocks) {
            const _dropzone = this;
            for (let i in files) {
                if (!files.hasOwnProperty(i)) {
                    continue;
